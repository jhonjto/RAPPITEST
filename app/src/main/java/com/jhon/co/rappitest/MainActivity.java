...
import com.jhon.co.rappitest.Utility.ItemData;
import com.jhon.co.rappitest.Utility.SampleItemAnimator;
...
private void initDataSet() {
        mDataSet.add(new ItemData(Color.parseColor("#76A9FC"), R.mipmap.ic_smartphone_white_24dp, "Social", new Date(2014 - 1900, 2, 9)));
        mDataSet.add(new ItemData(Color.GRAY, R.mipmap.ic_smartphone_white_24dp, "Ocio", new Date(2014 - 1900, 1, 3)));
        mDataSet.add(new ItemData(Color.GRAY, R.mipmap.ic_smartphone_white_24dp, "Juegos", new Date(2014 - 1900, 0, 9)));
        }

private void addItemData() {
        ItemData itemData = new ItemData(Color.parseColor("#FFC970"), R.mipmap.ic_smartphone_white_24dp, "Deportes", new Date());
